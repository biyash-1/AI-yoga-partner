...
# Remove tensorflowjs import - we'll convert manually
...
print('Keras model saved at saved_model/')
...
print('tensorflowjs_converter --input_format=keras saved_model model')