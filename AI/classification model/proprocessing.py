...
images_in_folder = os.path.join(script_dir, 'yoga_poses', 'train')
csvs_out_path = os.path.join(script_dir, 'train_data.csv')
...
images_in_folder = os.path.join(script_dir, 'yoga_poses', 'test')
csvs_out_path = os.path.join(script_dir, 'test_data.csv')
